...
namespace ITMO.CsharpWindowsForms.ExamApp.test_blockDataSetTableAdapters {
    ...
    public partial class t1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[t1] ([Name], [Number], [Price], [Discount]) VALUES (@Name, @Nu" +
                "mber, @Price, @Discount);\nSELECT ID, Name, Number, Price, Discount FROM t1 WHERE" +
                " (ID = SCOPE_IDENTITY())";
...
SELECT ID, Name, Number, Price, Discount FROM t1 WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITMO.CsharpWindowsForms.ExamApp.Properties.Settings.Default.test_blockConnectionString;
        }
